...
import BgImage from "../assets/imgs/tt.wedding.png";
import WeddingImageMobile from "../assets/imgs/mobile.wedding.png";
...
const deadline = new Date(1664614800000).getTime();
    ...
    <StyledWrapper ref={container}>
      ...
      <div className="box">
        ...
        <div className="date">
          ...
          <div className="time">01 Tháng 10 Năm 2022</div>
        </div>
      </div>
